...
#pragma pack(pop)
	...
	public:
		...
		virtual Image Parser(const Buffer& buffer) {
			...
			Image img;
			BITMAP_FILEHEADER* pFileHeader = reinterpret_cast<BITMAP_FILEHEADER*>(buffer.m_pData);
			BITMAP_HEADER* pBmpHeader = reinterpret_cast<BITMAP_HEADER*>(buffer.m_pData + BITMAP_FILEHEADER_SIZE);
