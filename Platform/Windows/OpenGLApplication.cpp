...
namespace My {
    GfxConfiguration config(8, 8, 8, 8, 32, 0, 0, 960, 540, L"3DEngine (Windows)");
...
void My::OpenGLApplication::Destroy()
{
    if (m_RenderContext) {
    ...
    WindowsApplication::Destroy();
}

void My::OpenGLApplication::Update()
{
    WindowsApplication::Update();
